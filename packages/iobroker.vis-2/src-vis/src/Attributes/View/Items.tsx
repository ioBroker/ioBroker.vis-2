...
export interface Field {
    ...
    /** The explanation (i18n), shown in the tooltip of the label */
    title?: string;
    /** The picture that explains the field, a key of HELP_IMAGES in Attributes/helpImages.tsx */
    helpImage?: string;
    min?: number;
    max?: number;
    step?: number;
            ...
            fields: [
                {
                    ...
                    noTranslation: true,
                    title: 'help_view_display',
                    // the grid with sections arranges the relative widgets by itself, see VisView.getRelativeStyle()
        ...
        },
        {
            ...
            fields: [
                ...
                },
                {
                    ...
                    label: 'Limit screen',
                    attr: 'limitScreen',
                    helpImage: 'limitScreen',
                    title: 'help_limit_screen',
                    hidden: 'data.sizex === undefined && data.sizey === undefined',
                    notStyle: true,
                },
                {
        ...
        },
        {
            ...
            fields: [
                ...
                },
                {
                    ...
                    helpImage: 'navigationOrientation',
                    notStyle: true,
                    default: 'vertical',
                    hidden: '!data.navigation',
                    applyToAll: true,
        ...
        },
        {
            ...
            */
                ...
                },
                {
                    ...
                    label: 'Column width',
                    attr: 'columnWidth',
                    helpImage: 'columnWidth',
                    title: 'help_column_width',
                    min: 200,
                    max: 2000,
                    step: 10,
                    notStyle: true,
                ...
                // the grid layout, see visGridLayout.ts; an unset value takes the default there
                {
                    ...
                    helpImage: 'sectionMinWidth',
                    title: 'help_section_min_width',
                ...
                },
                {
                    ...
                    helpImage: 'sectionMaxWidth',
                    title: 'help_section_max_width',
                ...
                },
                {
                    ...
                    attr: 'maxSections',
                    helpImage: 'maxSections',
                    title: 'help_max_sections',
                ...
                },
                {
                    ...
                    label: 'Section gap',
                    attr: 'sectionGap',
                    helpImage: 'sectionGap',
                    title: 'help_section_gap',
                ...
                },
                {
                    ...
                    attr: 'denseSections',
                    helpImage: 'denseSections',
                    title: 'help_dense_sections',
                    notStyle: true,
                    hidden: 'data.layout !== "grid"',
                },
            ] as Field[],
