...
import './index.css';
// PoC: runtime entry point renders the Runtime base class instead of the Editor,
// so the bundler never sees the editor import graph (multi-entry alternative to the
// tasks.js copy-and-substitute build).
