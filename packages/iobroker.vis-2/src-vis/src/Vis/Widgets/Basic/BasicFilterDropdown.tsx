...
function processFilter(filters: string[]): void {
                ...
                {items.map(option => {
                    ...
                    return (
                        <Button
                            ...
                            sx={theme => ({
                                backgroundColor: viewsActiveFilter.includes(option.value)
                                    ? this.state.rxData.buttonsVariant === 'contained'
