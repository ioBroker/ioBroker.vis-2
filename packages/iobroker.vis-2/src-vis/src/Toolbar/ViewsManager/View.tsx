...
const View = (props: ViewProps): React.JSX.Element => {
    const viewBlockPreview = (
        <Box
            component="div"
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        {props.openedViews.includes(props.name) ? (
                            <VisibilityIcon style={Utils.getStyle(props.theme, styles.visibleView)} />
                        ) : (
                            <VisibilityOffIcon />
                        )}
                    </IconButton>
                ...
                {props.hasPermissions ? (
                    ...
                    <span style={{ color: 'grey' }}>{props.name}</span>
                )}
                <Box
                    component="span"
                    sx={styles.viewManageButtonActions}
                >
                    {props.editMode && props.hasPermissions ? (
                        <Tooltip
                            title={I18n.t('Import')}
                            slotProps={{ popper: { sx: { pointerEvents: 'none' } } }}
                        >
                            <IconButton
                                onClick={() => props.setImportDialog(props.name)}
                                size="small"
                            >
                                <BiImport />
                            </IconButton>
                    ...
                    >
                        <IconButton
                            onClick={() => props.setExportDialog(props.name)}
                            size="small"
                        >
                            <BiExport />
                        </IconButton>
                    ...
                    {props.editMode && props.hasPermissions ? (
                        ...
                        >
                            <IconButton
                                onClick={() => props.showDialog('rename', props.name)}
                                size="small"
                            >
                                <EditIcon />
                            </IconButton>
                    ...
                    {props.editMode && props.hasPermissions ? (
                        ...
                        >
                            <IconButton
                                onClick={() => props.showDialog('copy', props.name)}
                                size="small"
                            >
                                <FileCopyIcon />
                            </IconButton>
                    ...
                    {props.editMode && props.hasPermissions ? (
                        ...
                        >
                            <IconButton
                                onClick={() => props.showDialog('delete', props.name)}
                                size="small"
                            >
                                <DeleteIcon />
                            </IconButton>
