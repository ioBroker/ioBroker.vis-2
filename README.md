...
* (@GermanBluefox) The dialog of the thermostat widget has two tabs now: the thermostat itself, at the size the dialog offers, and the history of its temperatures. Until now the dialog opened empty, as it only ever showed a chart that nothing switched to
