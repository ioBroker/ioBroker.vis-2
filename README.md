...
* (@GermanBluefox) The button of the theme switcher is as wide as the icon on it, not as wide as the place the widget has, and the variant `Text` of it has a word in every language again
